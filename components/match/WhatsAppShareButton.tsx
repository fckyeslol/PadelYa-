...
export function WhatsAppShareButton({
  ...
  const spotsText =
    spotsLeft <= 0 ? "¡Lleno!" : spotsLeft === 1 ? "1 cupo disponible" : `${spotsLeft} cupos disponibles`;
  ...
  return (
    <a
      href="#"
      onClick={(e) => { e.preventDefault(); window.open(buildWaUrl(), "_blank", "noopener,noreferrer"); }}
      target="_blank"
    ...
    >
      ...
      <span style={{ flex: 1 }}>
        {isParticipant ? "Invitar amigos por WhatsApp" : "Compartir partido"}
      </span>
